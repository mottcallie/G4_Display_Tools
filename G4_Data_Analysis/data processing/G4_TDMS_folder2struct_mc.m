function Log = G4_TDMS_folder2struct_mc(exp_folder)
%FUNCTION G4_TDMS_folder2struct_mc(exp_folder)
%
...
%
% Updated 11/4/2021 - MC changed folder saving for better script compatibility
...
%save the new .mat struct in experiment folder
